...
def process_video(video_file, model_file, output_directory=None):
    ...
    # Create list of segments with one-second padding
    segments = []
    start_time = None
    end_time = None
    ...
    for timestamp in sorted_timestamps:
        if start_time is None:
            ...
            segments.append((decrement_timestamp(start_time), increment_timestamp(end_time)))
            start_time = timestamp
            end_time = timestamp
